...
export const getDefaultChartOptions = (chartType) => {
    ...
    switch (type) {
        case 'line':
            return Object.assign(Object.assign({}, baseOptions), { chart: Object.assign(Object.assign({}, baseOptions.chart), { type: 'line' }), stroke: Object.assign(Object.assign({}, baseOptions.stroke), { curve: 'smooth' }), markers: {
                    size: 4,
                    strokeWidth: 0,
                    hover: {
                        size: 6
        ...
        case 'area':
            return Object.assign(Object.assign({}, baseOptions), { chart: Object.assign(Object.assign({}, baseOptions.chart), { type: 'area' }), fill: {
                    type: 'gradient',
                    gradient: {
                        shadeIntensity: 1,
                        opacityFrom: 0.7,
        ...
        case 'bar':
        case 'column':
            return Object.assign(Object.assign({}, baseOptions), { chart: Object.assign(Object.assign({}, baseOptions.chart), { type: chartType }), plotOptions: {
                    bar: {
                        borderRadius: 4,
                        columnWidth: '70%',
                        distributed: false,
        ...
        case 'radar':
            return Object.assign(Object.assign({}, baseOptions), { chart: Object.assign(Object.assign({}, baseOptions.chart), { type: 'radar' }), plotOptions: {
                    radar: {
                        size: undefined,
                        offsetX: 0,
                        offsetY: 0,
        ...
        case 'heatmap':
            return Object.assign(Object.assign({}, baseOptions), { chart: Object.assign(Object.assign({}, baseOptions.chart), { type: 'heatmap' }), plotOptions: {
                    heatmap: {
                        radius: 0,
                        enableShades: true,
                        shadeIntensity: 0.5,
        ...
        case 'timeline':
            return Object.assign(Object.assign({}, baseOptions), { chart: Object.assign(Object.assign({}, baseOptions.chart), { type: 'rangeBar' }), plotOptions: {
                    bar: {
                        horizontal: true,
                        barHeight: '50%',
                        rangeBarGroupRows: true
                    }
                }, xaxis: Object.assign(Object.assign({}, baseOptions.xaxis), { type: 'datetime' }) });
        default:
            return baseOptions;
    }
};
// Data table utilities
export const toggleDataTable = (tableElement, buttonElement) => {
...
export const makeSelectable = (elements) => {
...
export const formatNumber = (value, format = 'standard') => {
    if (isNaN(value))
        return '0';
    switch (format) {
        case 'currency':
...
export const generateDataTable = (series, categories, tableElement) => {
    if (!tableElement)
        return;

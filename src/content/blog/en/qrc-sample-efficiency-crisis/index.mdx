...
$$\text{Samples-per-feature ratio} = \frac{M}{N} \quad \text{(Eq. 1)}$$
...
| Figure | Description |
|--------|-------------|
| 1 | The quantum reservoir circuit architecture with parameterized rotation gates and CNOT entanglement |
| 2 | Spectral energy time series used in experiments |
| 3 | Performance comparison across three quantum systems |
| 4 | Sample efficiency analysis showing samples-per-feature relationship |
| 5 | Learning curves showing overfitting behavior |
| 6 | Forecast trajectories comparing predictions vs ground truth |
| 7 | QRC performance across chaotic systems with different Lyapunov exponents |
| 8 | Steinegger-Räth feature engineering pipeline |
| 9 | Noise characterization across IBM Heron r1 processor |
| 10 | Correlation matrix of quantum reservoir features |
| 11 | Ablation study results |
| 12 | Performance comparison across circuit topologies |
| 13 | Computational cost breakdown |

### Nomenclature

| Symbol | Definition | Unit |
|--------|------------|------|
| $R^2$ | Coefficient of determination (prediction accuracy) | — |
| $\lambda$ | Lyapunov exponent (chaos measure) | 1/time |
| $N$ | Number of features | — |
| $M$ | Number of training samples | — |
| $V$ | Number of temporal multiplexing steps | — |
| $r$ | Number of spatial reservoir copies | — |
| $G$ | Polynomial expansion degree | — |
| QRC | Quantum Reservoir Computing | — |
| CNOT | Controlled-NOT quantum gate | — |
| $R_y$ | Rotation gate around Y-axis | radians |

### Frequently Asked Questions

**What is quantum reservoir computing and how does it differ from classical reservoir computing?**
...
**Why did the 156-qubit system perform worse than the 9-qubit system?**
...
**What is the sample efficiency crisis?**
...
**How many qubits are optimal for quantum reservoir computing?**
...
**What is the Steinegger-Räth methodology?**
...
**Can noise help quantum reservoir computing?**
...
**What are the practical implications for quantum machine learning?**
...
The complete paper with additional technical details is available on [Zenodo (Open Access)](https://doi.org/10.5281/zenodo.17910992) and [ResearchGate](https://www.researchgate.net/publication/398615515).

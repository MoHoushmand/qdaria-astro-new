...
We have completed what is, to our knowledge, the largest quantum reservoir computing experiment on gate-based superconducting hardware. Using IBM's 156-qubit Heron r2 processor (ibm_fez, open plan), we went beyond the 120-qubit and 108-qubit demonstrations reported before. But the most important discovery was not about scale. It was about a fundamental crisis that changes how we must think about quantum machine learning.
...
Our second system scaled to IBM's full 156-qubit Heron r2 processor with 200 training samples. To our knowledge this is the largest quantum reservoir computing experiment on gate-based hardware reported so far.
...
We have presented what is, to our knowledge, the largest quantum reservoir computing experiment on gate-based hardware: 156 qubits on IBM's Heron r2 processor, ibm_fez, with job identifiers published alongside the code. But our key contribution is not the scale. It is the discovery of a fundamental sample efficiency crisis.

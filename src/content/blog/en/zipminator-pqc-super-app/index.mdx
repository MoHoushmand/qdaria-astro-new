...
<img src="/images/products/zipminator/zipminator-wordmark.svg" alt="Zipminator" style="display:inline;height:1.4em;vertical-align:middle" /> is built by QDaria AS, the same team that conducted a 156-qubit quantum reservoir computing experiment on IBM's Heron r2 processor. We do not just talk about quantum computing. We run experiments on real quantum hardware.
